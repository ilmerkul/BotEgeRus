...
kb_slider = InlineKeyboardMarkup(resize_keyboard=True)
b1 = InlineKeyboardButton(text='⬅', callback_data='update_slider⬅')
b2 = InlineKeyboardButton(text='➡', callback_data='update_slider➡')
kb_slider.insert(b1).insert(b2)
